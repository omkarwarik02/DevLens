    ...
    <div className="flex flex-col min-h-screen items-center justify-center">
      <div className="bg-[#161B22] items-center justify-center w-[420px] pb-10">
        ...
        <div className="flex flex-col mx-8">
          ...
          <button className="mt-6 bg-purple-600 h-[40px]">Sign Up</button>
        </div>
        ...
        <div className="flex items-center justify-center mt-10">
          <h3 className="text-[14px]">Already have an account? <span className="text-purple-500">Sign In</span></h3>
        </div>
      </div>
    </div>
  )
